          ...
          <div className='row justify-content-center justify-content-md-start'>
            <div className='col-md-6 col-lg-4 mb-4  '>
              ...
              <div className='socials d-flex gap-3'>
                <Link
                  to='https://twitter.com/prasadsontakk19'
                  id='footer-link'
                  target='_blank'
                  className='gap-3'
                >
                ...
                <Link
                  to='https://www.linkedin.com/in/prasad-sontakke-676814205/'
                  id='footer-link'
                  target='_blank'
                  className='gap-3'
                >
                ...
                <Link
                  to={'https://www.facebook.com/prasad.sontakke.3705/'}
                  className='gap-3'
                  id='footer-link'
                >
                  <BsFacebook />
                ...
                <Link
                  to='https://github.com/prasadsontakke77'
                  id='footer-link'
                  target='_blank'
                  className='gap-3'
                >
